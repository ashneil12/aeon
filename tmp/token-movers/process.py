...
STABLE_IDS = {
    ...
    "frax", "binance-usd", "busd", "usdp", "gusd", "lusd", "ethena-staked-usde",
    "susde", "usds", "usd1", "global-dollar", "fei-usd",
    "magic-internet-money", "mim", "ondo-us-dollar-yield", "usdy",
    "level-usd", "lvlusd", "openeden-tbill", "ousg", "tether-eurt",
    "stasis-eurs", "tether-gold", "pax-gold", "usdt0", "usdtb",
    "world-liberty-financial-usd", "usual-usd",
}
STABLE_SYMBOL_PREFIXES = ("USD", "EUR", "GBP")
STABLE_NAME_HINTS = ("stablecoin",)
...
WRAPPED_DUPE_IDS = {
    ...
    "bridged-wrapped-steth-scroll", "lombard-staked-btc", "kelp-dao-restaked-eth",
    "renzo-restaked-eth", "ether-fi-staked-eth", "solv-protocol-solvbtc",
}
